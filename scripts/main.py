...
from src.utils.utils import seed_everything, load_facts_from_csv
...
def main(task_name, agent_type):
    ...
    # facts, targets = load_facts_from_summary(gym_env, bb_model)
    ...
    # summary = generate_summary_states(gym_env, bb_model, realistic_df)
