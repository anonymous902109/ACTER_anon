...
from src.optimization.search.causal.highlights_search import HIGHLIGHTSSearch


class HIGHLIGHTS(AbstractBaseline):

    def __init__(self, env, bb_model, params=None):
        self.obj = BackObj(env, bb_model, params)
        self.optim = HIGHLIGHTSSearch(env, bb_model, self.obj, params)
