...
from src.optimization.search.causal.interest_local_max_search import InterestLocalMaxSearch


class InterestLocalMaxGen(AbstractBaseline):

    def __init__(self, env, bb_model, params=None):
        self.obj = BackObj(env, bb_model, params)
        self.optim = InterestLocalMaxSearch(env, bb_model, self.obj, params)

        super(InterestLocalMaxGen, self).__init__()
