...
from src.optimization.search.causal.interest_certain_search import InterestCertainSearch


class InterestCertainGen(AbstractBaseline):

    def __init__(self, env, bb_model, params=None):
        self.obj = BackObj(env, bb_model, params)
        self.optim = InterestCertainSearch(env, bb_model, self.obj, params)

        super(InterestCertainGen, self).__init__()
