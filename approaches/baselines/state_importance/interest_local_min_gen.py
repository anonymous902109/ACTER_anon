...
from src.optimization.search.causal.interest_local_min_search import InterestLocalMinSearch


class InterestLocalMinGen(AbstractBaseline):

    def __init__(self, env, bb_model, params=None):
        self.obj = BackObj(env, bb_model, params)
        self.optim = InterestLocalMinSearch(env, bb_model, self.obj, params)

        super(InterestLocalMinGen, self).__init__()
